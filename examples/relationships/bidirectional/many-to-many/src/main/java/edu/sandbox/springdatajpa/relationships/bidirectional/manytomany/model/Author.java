package edu.sandbox.springdatajpa.relationships.bidirectional.manytomany.model;
...
public class Author {
     ...
     * Owner of the relationship is Book, linked by 'authors' field in Book class. If required, Author can be owner side
     *
